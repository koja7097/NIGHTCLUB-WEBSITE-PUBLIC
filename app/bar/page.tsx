...
export default function BarPage() {
    ...
    return (
        ...
        <div className="flex gap-6 overflow-x-auto snap-x pb-6 scrollbar-hide">
          {drinks.map((drink) => (
            <div key={drink.id} className="snap-center shrink-0 w-72 bg-card rounded-2xl overflow-hidden border border-border shadow-lg hover:scale-105 transition-transform">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">{drink.type} • {drink.price}</p>
